      ...
      <div class="container">
        ...
        <div class="card" style=" border-top: 0; border-left: 0; border-right: 0; border-bottom: 3px solid grey;">
          <div class="card-body">
            ...
            <p class="card-text">Maaf pak sebelumnya, tapi saya mau saran kalau bisa ruang kumpul dan dapur diberi beberapa aturan supaya ruangannya tetap bersih. Terimakasih.</p>
          </div>
        </div>
