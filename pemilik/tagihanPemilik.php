                    ...
                    <div class="col-md-12">
                        ...
                        <table class="contact-table table table-curved">
                            ...
                            <tr>
                                ...
                                <th colspan="12" class="text-center">2021</th>
                                <th rowspan="2" style="vertical-align : middle;text-align:center;"><i style='font-size:24px' class='fas'>&#xf531;</i></th>
                            </tr>
                            <tr>
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td>Colombia</td>
                                    <td></td>
                                    <td><i class='fas fa-check' style='font-size:24px; color: #505050'></i</td>
                                    <td><i class='fas fa-check' style='font-size:24px; color: #505050'></td>
                                    <td><i class='fas fa-check' style='font-size:24px; color: #505050'></td>
                                    <td><i class='fas fa-check' style='font-size:24px; color: #505050'></td>
                                    <td></td>
                                    <td><i class='fas fa-check' style='font-size:24px; color: #505050'></td>
